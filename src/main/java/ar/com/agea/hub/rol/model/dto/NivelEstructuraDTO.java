/*
 * @(#)NivelEstructuraDTO.java		1.0 06/06/2013
 */
 ...
 */
public class NivelEstructuraDTO implements JSONDTO {
	
	private static final long serialVersionUID = 3697407379631076627L;
