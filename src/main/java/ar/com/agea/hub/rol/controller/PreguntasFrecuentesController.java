 ...
 */
@Controller
public class PreguntasFrecuentesController extends ROLController {
	...
	public ModelAndView showPreguntas(HttpSession session) {		
		return getModelAndView(ViewNamingName.PREGUNTAS);	
	}
	...
	public Map<String, ? extends Object> logout(HttpSession session, HttpServletResponse response) throws IOException {		
		...
		this.getLogger().debug("Ejecutando llamada de logout desde PreguntasFrecuentesController");
