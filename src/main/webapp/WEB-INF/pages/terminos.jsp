...
<html>
    <head>
	    ...
	    <body> 
			...
			<div class="primerbox">
				<div class="title">
					<h4 id="terminosYcondiciones">T&eacute;rminos y condiciones de uso:</h4>
				</div>
				<div class="nuevoaviso">
					<div id="btnNuevoAvisoTerminos" class="btn" onclick="gOnclickRedirectCrearAvisoHanlder(URLConstants.ROL_CREAR_AVISO)" class="genericBtn pull-right">
				...
				<ol>		
					...
					<li>A t&iacute;tulo enunciativo, y en ning&uacute;n caso limitativo o excluyente, los Usuarios se comprometen a:
						<ul>
							...
							<li>Usar cualquier mecanismo, software o rutina para impedir o intentar impedir el adecuado funcionamiento de este Sitio o cualquier actividad que se est&eacute; realizando en este Sitio. </li>
			...
			<content tag="myJavascript">  
         		<script src="${pageContext.servletContext.contextPath}/js/terminos/terminos.controller.js" type="text/javascript" charset="cp1252"></script>         		         		
			</content>	
	    </body>
	</html>